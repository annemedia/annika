...
ann.docs.annikainfo = async function annikainfo() {
    ...
    "<br>&nbsp;&nbsp;&nbsp;&nbsp;let <span class='cc-6'>footer</span> = '&amp;copy;' + <span class='color-3'>new Date().getFullYear()</span> + '&nbsp;Anne Media Developers.&nbsp;All Rights Reserved.';" +
    ...
    async function advancedsub() {
        ...
        let aresub2 = "There goes another example. The below Sub introduces a convenient method that outputs the known content of a JSON object into HTML view."
        ...
        "Note that the JSON 'print out' procedure can only provide a basic but helpful HTML output of a JSON object.</span>"
